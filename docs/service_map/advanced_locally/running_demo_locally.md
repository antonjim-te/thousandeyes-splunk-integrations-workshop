...
- Call a REST API of the OpenTelemetry demo application to generate some traces
    ...
    - Call a REST API
      ```
      curl http://localhost:8080:8080/api/cart -H 'traceparent: <your-traceparent-ID>
      ```
        - example:
        ```
        curl http://localhost:8080:8080/api/cart -H 'traceparent: 00-7b8aa5a2d2c872e8321cf37308d69df3-00f067aa0ba902b7-01'
        ```
