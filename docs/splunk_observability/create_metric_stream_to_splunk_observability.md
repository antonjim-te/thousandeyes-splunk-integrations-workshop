...
=== "API Method"
    ...
    - Open the `Create metrics stream - Splunk Observability` request in your Bruno collection
    - Click `Send` to execute the API request
    
    ![ThousandEyes create stream](../img/bruno/splunk_observability_metric_stream.png)
